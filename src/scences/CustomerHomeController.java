...
public class CustomerHomeController implements Initializable {
    ...
    void MyMaps(ActionEvent event) {
        ...
        String fillCityTableOT = "mSELECT m.* ,ot.purchasePrice FROM Maps m \n" +
                ...
                "WHERE cusID = " + customer.getCusID() + " AND m.cityID in (SELECT DISTINCT cityID FROM OT_Subscriptions WHERE cusID = " + customer.getCusID() + ")";
        ...
        String fillCityTableF = "nSELECT m.* ,f.purchasePrice, f.expireDate FROM Maps m \n" +
                ...
                "WHERE cusID = "+ customer.getCusID() + " AND m.cityID in (SELECT DISTINCT cityID FROM F_Subscriptions WHERE cusID = "  + customer.getCusID() + ")";
